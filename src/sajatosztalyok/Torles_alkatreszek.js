        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View>
              ...
              <TouchableOpacity
                style={{ backgroundColor: 'red', width: 75, borderRadius: 10,marginLeft:'auto',marginRight:'auto' }}
                onPress={() => torles(item.alkatresz_id)}
              >
                <Text style={{ color: "white", fontWeight: "bold", fontSize: 15,textAlign:'center' }}  >Törlés</Text>
              </TouchableOpacity>
